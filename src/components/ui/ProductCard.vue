<template>
  <div class="product-wrapper" v-if="item" @click="goToProduct(item)">
    <div class="inner-item">
      <div class="img-wrapper">
        ...
        <img v-lazy="item.image" class="main-img img-fluid" :alt="item.name" />
        <img v-lazy="item.image" class="hover-img img-fluid" :alt="item.name" />
      </div>
      <div class="caption">
        <h3 class="name">{{ item[$i18n.locale].name }}</h3>
